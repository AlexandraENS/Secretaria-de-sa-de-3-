...
Desse modo, demostramos que o resutado da regressão os dados não são siginificantes estatisitcamente para explicar nossa hipótese da influência de gênero na duração dos mandatos nas secretarias estaduais de saúde. 
