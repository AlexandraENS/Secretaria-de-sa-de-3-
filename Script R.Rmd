...
## Centro-Oeste
#esse códigos geram uma tabela com as variáveis de duração de mandato e gênero por região.
```{r echo=FALSE}
...
```{r include=FALSE}
#aqui definimos as ideologias dos partidos e também criamos uma coluna para ideologia
...
```{r echo=FALSE}
#A fórmula de regressão multivariada é rodada aqui com todas as variáveis de interesse
