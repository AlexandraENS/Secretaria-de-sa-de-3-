...
O modelo que usamos aqui foi a regressão linear, pois esta é utilizada para verificar se existe significancia estatística na correlação entre duas variáveis. 
